...
const Hero = () => {
  return (
    <section className="grid md:grid-cols-2 gap-0 min-h-[400px] md:min-h-[600px]">
      <div
        className="relative bg-cover bg-center flex items-end justify-start min-h-[300px] md:min-h-0 rounded-xl"
      ...
      <div className="bg-background p-6 md:p-8 lg:p-12 flex flex-col justify-center">
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-4 md:mb-6">
          COMAR NET <br /> Aproape două decenii de experiență ne permit să
          oferim servicii de distribuție rapide, sigure și orientate spre
          calitate.
        </h1>
